...
#:import TimebotSplashScreen libs.baseclass.splash_screen.TimebotSplashScreen
#:import TimebotRootScreen libs.baseclass.root_screen.TimebotRootScreen

ScreenManager:
    transition: FadeTransition()

    TimebotSplashScreen:
        name: "timebot splash screen"

    TimebotRootScreen:
        name: "timebot root screen"
