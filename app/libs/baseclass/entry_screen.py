...
class TimebotEntryScreen(MDScreen):
    ...
    def add_entry_row(self, entry):
        entry_row_box = MDBoxLayout(orientation='horizontal', size_hint=(None, None), height="50dp", width=self.task_width, padding=0, spacing=0, line_color=gch('ffffff'), radius="10dp", pos_hint=self.top_center)
