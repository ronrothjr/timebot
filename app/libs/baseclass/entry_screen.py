...
class TimebotEntryScreen(MDScreen):
    ...
    def on_enter(self):
        ...
        for project in projects:
            ...
            project_layout = MDBoxLayout(adaptive_size=True, size_hint=(None, None), size=project_card.size, pos_hint={"center_x": .5, "center_y": .5})
    ...
    def released(self, instance):
        Utils.switch_project_code_task(instance.children[0].children[0].text)
