...
class TimebotTimecardsScreen(MDScreen):
    ...
    def add_weekday(self, weekday):
        weekday_box = MDBoxLayout(adaptive_height=True, orientation='vertical', size_hint=(None, None), width="340", pos_hint=self.center_center, padding=(10, 0, 0, 0), md_bg_color=gch('242424'), radius=[20, 7, 20, 7])
